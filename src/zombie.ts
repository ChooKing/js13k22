...
export class Zombie extends Drawable{
    ...
    constructor(x: number, y: number, col: Point[]) {
        ...
        const tc=randc();
        const bc=randc();
        this.armL=new Paths(ps.arm(tc, c[1]));
        this.armR=new Paths(ps.arm(tc, c[1]));
        ...
        this.footR=new Paths(ps.foot({r:0,g:0,b:0}));
        this.footL=new Paths(ps.foot({r:0,g:0,b:0}));
